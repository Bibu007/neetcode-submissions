class Solution {
    ...
    pacificAtlantic(heights) {
        ...
        for(let i = 0; i < cols; i++){
            this.dfs(heights, 0, i, visitPac, 0);
            this.dfs(heights, rows - 1, i, visitAtl, 0);
        }

        for(let i = 0; i < rows; i++){
            this.dfs(heights, i, 0, visitPac, 0);
            this.dfs(heights, i, cols - 1, visitAtl, 0);
        }
    ...
    dfs(heights, i, j, visit, parentHeight){
        ...
        this.dfs(heights, i, j - 1, visit, curHeight);
        this.dfs(heights, i + 1, j, visit, curHeight);
        this.dfs(heights, i, j + 1, visit, curHeight);
        this.dfs(heights, i - 1, j, visit, curHeight);
    }
}
